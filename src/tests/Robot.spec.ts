...
describe('When moving forward', () => {
    ...
    it('should move BACKWARDS on the X axis if facing West', () => {
        robot = new Robot(grid, '1 1 W');
        robot.move('F');
...
describe('When moving backwards', () => {
    ...
    it('should move DOWN on the Y axis if facing North', () => {
        robot = new Robot(grid, '1 1 N');
        robot.move('B');
        expect(robot.x).to.equal(1);
        expect(robot.y).to.equal(0);
    ...
    it('should move UP on the Y axis if facing South', () => {
        robot = new Robot(grid, '1 1 S');
        robot.move('B');
        expect(robot.x).to.equal(1);
        expect(robot.y).to.equal(2);
    ...
    it('should move BACKWARDS on the X axis if facing East', () => {
        robot = new Robot(grid, '1 1 E');
        robot.move('B');
        expect(robot.x).to.equal(0);
        expect(robot.y).to.equal(1);
    ...
    it('should move FORWARDS on the X axis if facing West', () => {
        robot = new Robot(grid, '1 1 W');
        robot.move('B');
        expect(robot.x).to.equal(2);
        expect(robot.y).to.equal(1);
